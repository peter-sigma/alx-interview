#!/usr/bin/python3
"""Solving lockboxes lock boxes """


def look_next_opened_box(opened_boxes):
    """Look for the next opened box
    Args:
        opened_boxes (dict): Contains dictionary of boxes already opened
    Returns:
        list: List of the keys contained in the opened box
    """
...
def canUnlockAll(boxes):
    ...
    Args:
        boxes (list): Contains a list of all boxes with the keys
    Returns:
